...
fun FunctionExplained() {
  Column {
    ...
    Spacer(modifier = Modifier.height(16.dp))
    Text(text = "The () after myFunction is the function call operator, you can just think of it as the place to provide any information we need to execute the function.")
    Spacer(modifier = Modifier.height(16.dp))
    ...
    Spacer(modifier = Modifier.height(16.dp))
    Text(text = "In between the {} is where the actually code that is contained by the function goes.")
    Spacer(modifier = Modifier.height(16.dp))
